    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-9 ms-sm-auto px-md-4 mt-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h2 class="fw-bold">Thêm Danh Mục</h2>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-5">
                    <form action="/shop_quan_ao/admin/categoryAdd" method="POST">
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="5" placeholder="Mô tả danh mục..."></textarea>
                                </div>
